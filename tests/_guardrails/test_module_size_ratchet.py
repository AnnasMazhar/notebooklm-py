...
SHRINK_LOCKED_CEILINGS: dict[str, int] = {
    # 1225 -> 1449: maintainer-sanctioned exception for #2257, NOT a precedent.
    ...
    # Still shrink-only from 1449. The next change to this module that frees
    # lines should lower this back down; the gate prints the exact value.
    "_auth/browser_capture.py": 1449,
