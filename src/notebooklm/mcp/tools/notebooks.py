    ...
    async def notebook_describe(
        ...
        with mcp_errors():
            ...
            if include_metadata:
                ...
                # NotebookMetadataService now applies the shared SourceCounts
                # definition to the enumerated source collection. Both the legacy
                # scalar and the explicit counters therefore arrive consistently
                # here without an adapter-local projection (#1919, #1962).
