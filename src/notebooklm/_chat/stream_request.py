"""Credential-aware request encoding for streamed Chat calls.

This remains outside the semantic web backend package: it consumes an already
acquired runtime snapshot but does not acquire or persist credentials.
"""
