...
class ClientComposed:
    ...
    def __init__(
        ...
        *,
        ...
        self._rpc_semaphore = RpcSemaphore(max_concurrent_rpcs)
    ...
    def max_concurrent_rpcs(self) -> int | None:
        """Return the configured logical-RPC concurrency ceiling."""
        return self._rpc_semaphore.max_concurrent_rpcs

    @property
    def rpc_semaphore(self) -> RpcSemaphore:
        """Return the focused owner of the logical-RPC concurrency gate."""
    ...
    def set_bound_loop(self, loop: asyncio.AbstractEventLoop | None) -> None:
        """Delegate lifecycle loop binding to the RPC gate owner."""
        self._rpc_semaphore.set_bound_loop(loop)
    ...
    def reset_after_open(self) -> None:
        ...
        """
        self._rpc_semaphore.reset_after_open()
    ...
    def get_rpc_semaphore(self) -> AbstractAsyncContextManager[Any]:
        ...
        """
        return self._rpc_semaphore.get()
