...
REVIEWED_BACKEND_IMPORTS = frozenset(
    {
        ...
        ("_web/backend.py", "_records", "AudioGenerateInput"),
        ("_web/backend.py", "_records", "AudioGenerateResult"),
        ("_web/backend.py", "_records", "GenerationStatusRecord"),
        ("_web/backend.py", "_records", "InteractiveGenerateInput"),
        ("_web/backend.py", "_records", "InteractiveGenerateResult"),
        ...
        ("_web/backend.py", "studio_documents", "StudioDocumentWebHandlers"),
