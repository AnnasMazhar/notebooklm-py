...
REVIEWED_BACKEND_IMPORTS = frozenset(
    {
        ("_artifact/downloads.py", "_projectors", "project_artifact"),
        ...
        ("_web/backend.py", "_records", "LabelCreateInput"),
        ("_web/backend.py", "_records", "LabelCreateResult"),
        ("_web/backend.py", "_records", "LabelDeleteInput"),
        ("_web/backend.py", "_records", "LabelDeleteResult"),
        ("_web/backend.py", "_records", "LabelGenerateInput"),
        ("_web/backend.py", "_records", "LabelGenerateResult"),
        ("_web/backend.py", "_records", "LabelGetInput"),
        ("_web/backend.py", "_records", "LabelGetResult"),
        ("_web/backend.py", "_records", "LabelKind"),
        ("_web/backend.py", "_records", "LabelListInput"),
        ("_web/backend.py", "_records", "LabelListResult"),
        ("_web/backend.py", "_records", "LabelRecord"),
        ("_web/backend.py", "_records", "LabelUpdateInput"),
        ("_web/backend.py", "_records", "LabelUpdateResult"),
...
_KEYWORD_BACKEND_FACADES = frozenset({"ArtifactsAPI", "NoteService", "NotebooksAPI", "SourcesAPI"})
