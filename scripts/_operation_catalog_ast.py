...
REVIEWED_BACKEND_IMPORTS = frozenset(
    {
        ...
        ("_web/backend.py", "_records", "DataTableGenerateInput"),
        ("_web/backend.py", "_records", "DataTableGenerateResult"),
        ("_web/backend.py", "_records", "DriveExportInput"),
        ("_web/backend.py", "_records", "DriveExportResult"),
        ("_web/backend.py", "_records", "GenerationStatusRecord"),
        ("_web/backend.py", "_records", "MindMapGenerateInput"),
        ("_web/backend.py", "_records", "MindMapGenerateResult"),
