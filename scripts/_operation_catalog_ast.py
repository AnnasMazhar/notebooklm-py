...
REVIEWED_BACKEND_IMPORTS = frozenset(
    {
        ...
        ("_web/backend.py", "_projectors", "project_source"),
...
REVIEWED_BACKEND_IMPORTS |= frozenset(
    {
        ...
        ("_web/backend.py", "_records", "SourceAddDriveInput"),
        ("_web/backend.py", "_records", "SourceAddDriveResult"),
        ("_web/backend.py", "_records", "SourceAddFileInput"),
        ("_web/backend.py", "_records", "SourceAddFileResult"),
        ("_web/backend.py", "_records", "SourceAddTextInput"),
        ("_web/backend.py", "_records", "SourceAddTextResult"),
        ("_web/backend.py", "_records", "SourceAddUrlBatchInput"),
        ("_web/backend.py", "_records", "SourceAddUrlBatchResult"),
        ("_web/backend.py", "_records", "SourceDeleteInput"),
        ("_web/backend.py", "_records", "SourceDeleteResult"),
        ("_web/backend.py", "_records", "SourceFileInputKind"),
        ("_web/backend.py", "_records", "SourceFreshnessInput"),
        ("_web/backend.py", "_records", "SourceFreshnessResult"),
        ("_web/backend.py", "_records", "SourceFulltextInput"),
        ("_web/backend.py", "_records", "SourceFulltextRecord"),
        ("_web/backend.py", "_records", "SourceFulltextResult"),
        ("_web/backend.py", "_records", "SourceGuideInput"),
        ("_web/backend.py", "_records", "SourceGuideRecord"),
        ("_web/backend.py", "_records", "SourceGuideResult"),
        ("_web/backend.py", "_records", "SourceRefreshInput"),
        ("_web/backend.py", "_records", "SourceRefreshResult"),
        ("_web/backend.py", "_records", "SourceUpdateInput"),
        ("_web/backend.py", "_records", "SourceUpdateResult"),
        ("_web/backend.py", "_records", "SourceUrlBatchItemRecord"),
