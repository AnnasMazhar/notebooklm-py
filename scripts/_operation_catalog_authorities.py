...
SHARED_RPC_AUTHORITY_RULES.update(
    {
        ...
        (Operation.LABEL_LIST, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "label_type=source")
        ),
        (Operation.LABEL_GET, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "select source-label id")
        ),
        (Operation.LABEL_SOURCES, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "resolve source-label membership")
        ),
        (Operation.COLLECTION_LIST, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "label_type=collection")
        ),
        (Operation.COLLECTION_GET, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "select collection id")
        ),
        (Operation.LABEL_CREATE, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "pre-create identity baseline")
        ),
        (Operation.LABEL_UPDATE, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "update preflight/readback")
        ),
        (Operation.COLLECTION_CREATE, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "baseline/create readback")
        ),
        ...
        (Operation.COLLECTION_NOTEBOOKS, _b(RPCMethod.LIST_LABELS)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_list", "resolve collection membership")
        ),
        ...
        (Operation.LABEL_UPDATE, _b(RPCMethod.UPDATE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._label_update", "label field-mask mutation")
        ),
        (Operation.COLLECTION_UPDATE, _b(RPCMethod.UPDATE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._collection_update", "collection name mutation")
        ),
...
SHARED_RPC_AUTHORITY_RULES.update(
    {
        (Operation.LABEL_GENERATE, _b(RPCMethod.CREATE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._label_generate", "label_mode=auto-group")
        ),
        (Operation.LABEL_CREATE, _b(RPCMethod.CREATE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._label_create", "label_type=source")
        ),
        (Operation.COLLECTION_CREATE, _b(RPCMethod.CREATE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._collection_create", "label_type=collection")
        ),
        ...
        (Operation.LABEL_DELETE, _b(RPCMethod.DELETE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_delete", "label_type=source")
        ),
        (Operation.COLLECTION_DELETE, _b(RPCMethod.DELETE_LABEL)): _rules(
            ("_web/backend.py:WebRpcBackend._label_set_delete", "label_type=collection")
        ),
