...
claim that P1-P3 or P5-P8 are complete. P4 convergence is implemented for the eight currently
active semantic operations; each later migration extends the same policy/deadline/error gates.
P9 public-API work and a mobile backend are separate decisions.
