...
absolute deadline. P3's first live codec routes GET_SOURCE structured documents through the strict
web codec boundary. The remaining phase descriptions are sequencing decisions, not a claim that
the rest of P3-P8 are complete. P9 public-surface work and a mobile backend require separate
decisions.
