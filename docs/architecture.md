...
| `_projectors.py` | Compatibility projectors from neutral notebook/source/artifact records to the existing public models, using their normal constructors and no wire adapters. |
...
├── _projectors.py               # Neutral record-to-public Notebook/Source/Artifact projectors
