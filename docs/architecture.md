...
| `_auth/profile_store.py` | Path-owned fresh document/session/account reads, bounded account update/clear, blocking cookie transactions, and typed browser/remint replacement with raw namespace carry (ADR-0034) |
