...
| `_auth/login_wait_trace.py` | `log_observed_navigations` — DEBUG per-navigation tracing for the interactive login wait (`-vv` self-diagnosis); redacts via `_safe_url`, inert when DEBUG is off; pure leaf of `browser_capture.py` (ADR-0008) |
