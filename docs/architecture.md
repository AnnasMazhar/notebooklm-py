...
| [`_auth/browser_state_validation.py`](../src/notebooklm/_auth/browser_state_validation.py) | Playwright storage-state validation bridge that preserves captured cookie attributes before persistence. |
...
| `_auth/browser_state_validation.py` | Playwright storage-state validation preserving cookie attributes |
...
│   ├── browser_state_validation.py # Playwright state validation preserving cookie attributes
